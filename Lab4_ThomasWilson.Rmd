...
ggplot(data = top10d_3_13, aes( x = Deaths)) +
  geom_bar()
ggplot(data = top10d_3_13, aes( x = Confirmed)) +
  geom_bar()
...
ggplot(data = top10d_9_13, aes( x = Deaths)) +
  geom_bar()
ggplot(data = top10d_9_13, aes( x = Confirmed)) +
  geom_bar()
